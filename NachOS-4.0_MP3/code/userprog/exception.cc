...
ExceptionHandler(ExceptionType which)
{
	...
	switch(type) {
		...
		case SC_Read:// hw1
        {
			...
			arg1 = kernel->machine->ReadRegister(4); //addr of string to store
			arg2 = kernel->machine->ReadRegister(5); //no of charaters to read
			arg3 = kernel->machine->ReadRegister(6); //file descriptor
		...
		case SC_Write://hw1
        {
			...
			arg1 = kernel->machine->ReadRegister(4); // address to write
			arg2 = kernel->machine->ReadRegister(5); // size
			arg3 = kernel->machine->ReadRegister(6); //file id
		...
		case SC_Close:// hw1
        {
			...
			arg1 = kernel->machine->ReadRegister(4); //filedescriptor of file to be closed
	...
	case MemoryLimitException: // hw2 for exceed the frame limit.
		cerr << "Can not allocate sufficient frames for new thread.\n";
	break;
